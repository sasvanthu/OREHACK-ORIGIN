...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const enterHandler = (e: Event) => {
      ...
      // Fade in the cursor brackets
      gsap.to(cursorRef.current, { opacity: 1, duration: 0.15, ease: 'power2.out' });
      corners.forEach((corner, i) => {
        gsap.to(corner, {
      ...
      const leaveHandler = () => {
        ...
        // Fade out the cursor brackets
        gsap.to(cursorRef.current, { opacity: 0, duration: 0.2, ease: 'power2.in' });
